...
function regist_contract_end_report(h_act, h_no)
{
    ...
    $.ajax({
        ...
        data:{
            ...
            'remarks2': $('#remarks2').val(),
            'remarks_pay2': $('#remarks_pay2').val(),
            'claim_normal_calculation_end': $('[name=claim_normal_calculation_end] option:selected').text(),
            'claim_normal_unit_price_end': $('#claim_normal_unit_price_end').val(),
            'claim_normal_lower_limit_end': $('#claim_normal_lower_limit_end').val(),
            'claim_normal_upper_limit_end': $('#claim_normal_upper_limit_end').val(),
            'claim_normal_deduction_unit_price_end': $('#claim_normal_deduction_unit_price_end').val(),
            'claim_normal_over_unit_price_end': $('#claim_normal_over_unit_price_end').val(),
            'claim_leaving_employment_day_end': $('#claim_leaving_employment_day_end').val(),
            'claim_leaving_allbusiness_day_end': $('#claim_leaving_allbusiness_day_end').val(),
            'claim_leaving_calculation_end': $('[name=claim_leaving_calculation_end] option:selected').text(),
            'claim_leaving_unit_price_end': $('#claim_leaving_unit_price_end').val(),
            'claim_leaving_lower_limit_end': $('#claim_leaving_lower_limit_end').val(),
            'claim_leaving_upper_limit_end': $('#claim_leaving_upper_limit_end').val(),
            'claim_leaving_deduction_unit_price_end': $('#claim_leaving_deduction_unit_price_end').val(),
            'claim_leaving_over_unit_price_end': $('#claim_leaving_over_unit_price_end').val(),
            'payment_normal_calculation_1_end': $('[name=payment_normal_calculation_1_end] option:selected').text(),
            'payment_normal_calculation_2_end': $('[name=payment_normal_calculation_2_end] option:selected').text(),
            'payment_normal_unit_price_1_end': $('#payment_normal_unit_price_1_end').val(),
            'payment_normal_unit_price_2_end': $('#payment_normal_unit_price_2_end').val(),
            'payment_normal_lower_limit_1_end': $('#payment_normal_lower_limit_1_end').val(),
            'payment_normal_lower_limit_2_end': $('#payment_normal_lower_limit_2_end').val(),
            'payment_normal_upper_limit_1_end': $('#payment_normal_upper_limit_1_end').val(),
            'payment_normal_upper_limit_2_end': $('#payment_normal_upper_limit_2_end').val(),
            'payment_normal_deduction_unit_price_1_end': $('#payment_normal_deduction_unit_price_1_end').val(),
            'payment_normal_deduction_unit_price_2_end': $('#payment_normal_deduction_unit_price_2_end').val(),
            'payment_normal_over_unit_price_1_end': $('#payment_normal_over_unit_price_1_end').val(),
            'payment_normal_over_unit_price_2_end': $('#payment_normal_over_unit_price_2_end').val(),
            'payment_leaving_employment_day_1_end': $('#payment_leaving_employment_day_1_end').val(),
            'payment_leaving_employment_day_2_end': $('#payment_leaving_employment_day_2_end').val(),
            'payment_leaving_allbusiness_day_1_end': $('#payment_leaving_allbusiness_day_1_end').val(),
            'payment_leaving_allbusiness_day_2_end': $('#payment_leaving_allbusiness_day_2_end').val(),
            'payment_leaving_calculation_1_end': $('[name=payment_leaving_calculation_1_end] option:selected').text(),
            'payment_leaving_calculation_2_end': $('[name=payment_leaving_calculation_2_end] option:selected').text(),
            'payment_leaving_unit_price_1_end': $('#payment_leaving_unit_price_1_end').val(),
            'payment_leaving_unit_price_2_end': $('#payment_leaving_unit_price_2_end').val(),
            'payment_leaving_lower_limit_1_end': $('#payment_leaving_lower_limit_1_end').val(),
            'payment_leaving_lower_limit_2_end': $('#payment_leaving_lower_limit_2_end').val(),
            'payment_leaving_upper_limit_1_end': $('#payment_leaving_upper_limit_1_end').val(),
            'payment_leaving_upper_limit_2_end': $('#payment_leaving_upper_limit_2_end').val(),
            'payment_leaving_deduction_unit_price_1_end': $('#payment_leaving_deduction_unit_price_1_end').val(),
            'payment_leaving_deduction_unit_price_2_end': $('#payment_leaving_deduction_unit_price_2_end').val(),
            'payment_leaving_over_unit_price_1_end': $('#payment_leaving_over_unit_price_1_end').val(),
            'payment_leaving_over_unit_price_2_end': $('#payment_leaving_over_unit_price_2_end').val(),
        },
        success: function(data, dataType){
            if (data == 'OK'){
                alert(a_sKind + "しました。");

...
<p class="c">
<input type="button" value="アップロード" onclick="return upload_time_table_file();">
<input type="button" value="一覧に戻る" onclick="location.href='./index.php?mnu=<?php echo $GLOBALS['g_MENU_MAINTENANCE_90500']; ?>'">
</p>

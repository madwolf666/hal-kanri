...
try{
    ...
    //レコードが存在するかチェック
    $a_sql = "SELECT * FROM ".$GLOBALS['g_DB_t_dispatching_management_ledger']." WHERE (cr_id=:cr_id);";
    ...
    if ($a_isExists == false){
        $a_sql = "INSERT INTO ".$GLOBALS['g_DB_t_dispatching_management_ledger']." (";
        ...
        $a_sql = "UPDATE ".$GLOBALS['g_DB_t_dispatching_management_ledger']." SET ";
